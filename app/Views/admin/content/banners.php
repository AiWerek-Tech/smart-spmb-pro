...
<section class="admin-page-shell animate-fade-in" aria-labelledby="admin-banners-title">
    <header class="admin-page-header">
        <div>
            <p class="admin-panel__kicker">Konten Publik</p>
            <h1 id="admin-banners-title">Banner Hero</h1>
            <p class="admin-page-subtitle">Kelola konten utama yang muncul di bagian atas beranda.</p>
        </div>
    ...
    <section class="admin-secondary-panel" aria-labelledby="banner-table-title">
        <div class="admin-secondary-panel__header">
            <div>
                <h2 class="admin-section-title" id="banner-table-title">Daftar Banner</h2>
                <p class="admin-section-subtitle">Atur urutan, status, dan CTA banner beranda.</p>
            </div>
        </div>
