...
class SettingController extends BaseController
{
    ...
    public function save()
    {
        $rules = [
            ...
            'phone'         => 'required',
            'address'       => 'required',
            'maps_lat'      => 'permit_empty|decimal',
            'maps_lng'      => 'permit_empty|decimal',
            'maps_zoom'     => 'permit_empty|integer|greater_than_equal_to[1]|less_than_equal_to[20]',
        ...
        $settingsData = [
            ...
            'maps_embed'         => '',
            'maps_query'         => $this->request->getPost('maps_query'),
            'maps_lat'           => $this->request->getPost('maps_lat'),
            'maps_lng'           => $this->request->getPost('maps_lng'),
            'maps_zoom'          => $this->request->getPost('maps_zoom') ?: '16',
